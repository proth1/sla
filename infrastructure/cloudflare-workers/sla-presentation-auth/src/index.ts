/**
 * SLA Governance Presentation Auth Worker
 *
 * Server-side OTP authentication for SLA Governance presentation using Descope.
...
<head>
  ...
  <title>Access Denied - Software Lifecycle Automation</title>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Sign In - Software Lifecycle Automation</title>
  <link href="https://fonts.googleapis.com/css2?family=Open+Sans+Condensed:wght@300;700&family=Open+Sans:wght@300;400;600;700&display=swap" rel="stylesheet">
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body {
...
<body>
  <div class="login-container">
    <div class="logo">
      ${SLA_LOGO_SVG}
      <div class="product-tagline">Software Lifecycle Automation</div>
    </div>
    <p class="subtitle">Sign in to access the SLA platform presentation</p>
